...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."_locales" AS ENUM('en', 'uk', 'ru');
  CREATE TYPE "public"."enum_pages_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__pages_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__pages_v_published_locale" AS ENUM('en', 'uk', 'ru');
  ...
  CREATE TABLE "pages_blocks_hero_locales" (
  	"badge_text" varchar DEFAULT 'Trusted by spiritual seekers worldwide',
  	"heading" varchar DEFAULT 'Transform your workflow with spiritual awakening',
  	"subtitle" varchar DEFAULT 'Track the growth and engagement of your consciousness through detailed practices. Understand what works and supercharge your inner journey.',
  	"cta_form_input_placeholder" varchar DEFAULT 'Enter Email',
  	"cta_form_button_text" varchar DEFAULT 'Join Waitlist',
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  ...
  ALTER TABLE "pages_blocks_hero" ADD CONSTRAINT "pages_blocks_hero_badge_icon_id_media_id_fk" FOREIGN KEY ("badge_icon_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_hero" ADD CONSTRAINT "_pages_v_blocks_hero_badge_icon_id_media_id_fk" FOREIGN KEY ("badge_icon_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "pages_blocks_hero_badge_badge_icon_idx" ON "pages_blocks_hero" USING btree ("badge_icon_id");
  ...
  CREATE INDEX "_pages_v_blocks_hero_badge_badge_icon_idx" ON "_pages_v_blocks_hero" USING btree ("badge_icon_id");
